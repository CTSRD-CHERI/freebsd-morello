...
# in case when bootefi does not work
echo "setenv serverip 10.5.0.1; setenv ipaddr 10.5.0.93; tftp 0x88000000 codasip_vcu118/x730-mp1-hobgoblin-vcu118.dtb; tftp 0x82000000 codasip_vcu118/kernel.bin; go 0x82000000"
